#include "gz_fft_waves/core/WavefieldSampler.hh"
#include "gz_fft_waves/core/CGALTypes.hh"
#include "gz_fft_waves/core/Grid.hh"
#include "gz_fft_waves/core/Utilities.hh"
#include "gz_fft_waves/core/Wavefield.hh"
...
WavefieldSampler::WavefieldSampler(
  ...
  std::shared_ptr<const Grid> patch) : impl_(new WavefieldSamplerPrivate()) {
...
void WavefieldSampler::ApplyPose(const gz::math::Pose3d& pose) {
  ...
  for (auto&& it = std::make_pair(std::begin(source.vertices()),
